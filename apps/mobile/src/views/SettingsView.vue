...
const pluginCapabilityDefinitions: Array<{
      ...
      <div class="panel-body">
        ...
        <div v-if="nodeStore.plugins.length" class="plugin-card-list">
          <article v-for="plugin in nodeStore.plugins" :key="plugin.pluginId" class="plugin-card">
            ...
            <p class="section-note">
              Android permissions:
              {{ plugin.androidPermissions.join(", ") || "None declared" }}
            </p>
            ...
            <template v-else>
              <div class="plugin-capability-grid">
                <label
                  v-for="capability in pluginCapabilityDefinitions.filter((item) => plugin.declaredCapabilities[item.key])"
                  :key="capability.key"
                  class="checkbox"
                >
                  <input
